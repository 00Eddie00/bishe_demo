...
<body id="body">
<div id="max">
    <div id="top"><b>commentNum Top10</b></div>
    <!-- 置入统计表 -->
    <div id="echarts"></div>
    <c:forEach items="${hotelListByCommentNum}" var="h">
    ...
    <script type="text/javascript">
        window.onload = () => {
            ...
            var option = {
                ...
                series: [{
                    name: 'commentNum',/* 此处设置对应柱状的值 */
                    type: 'bar',/* 此处设置图的种类 */
                    data: [...res],/* 此处填写柱状图数据，与横轴一一对应 */
                    ...
                    itemStyle: {
                        ...
                        normal: {
                            ...
                            color: function (params) {
                                var colorList = ['rgb(220,170,230)', 'rgb(200,170,230)', 'rgb(180,170,230)', 'rgb(160,170,230)', 'rgb(140,170,230)', 'rgb(120,170,230)', 'rgb(100,170,230)', 'rgb(80,170,230)', 'rgb(60,170,230)', 'rgb(40,170,230)'];
